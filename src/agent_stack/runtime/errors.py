...
_EXIT_CODES = {
    ...
    "AWP_SOURCE_RELEASE_VERIFICATION_FAILED": 30,
    "AWP_WORKSPACE_SOURCE_METADATA_REQUIRED": 21,
    "AWP_WORKSPACE_MIGRATION_REQUIRED": 21,
    "AWP_WORKSPACE_CONTRACT_AHEAD": 21,
    "AWP_WORKSPACE_CONTRACT_DIVERGED": 21,
    "AWP_WORKSPACE_TASK_RECOVERY_BLOCK": 21,
    "AWP_WORKSPACE_ACTIVE_TASK_BLOCK": 22,
    "AWP_WORKSPACE_TASK_LAYOUT_AMBIGUOUS": 22,
    "AWP_WORKSPACE_LAYOUT_STATE_STRANDED": 22,
