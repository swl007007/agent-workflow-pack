...
**v0.1.6 is an immutable failed release and must not be used. No accepted release is
currently available.**

Versions `0.1.0` through `0.1.6` are retained as failed publications or candidates. Their tags, release
